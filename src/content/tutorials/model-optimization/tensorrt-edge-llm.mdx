...
<tbody>
<tr style="background: #f8fafc;"><td style="padding: 12px 16px; border-bottom: 1px solid #e2e8f0; font-weight: 600; color: #334155;">JetPack</td><td style="padding: 12px 16px; border-bottom: 1px solid #e2e8f0;">7.2 / Jetson Linux R39.2</td><td style="padding: 12px 16px; border-bottom: 1px solid #e2e8f0;">7.1</td></tr>
...
<Tabs labels={["Jetson Thor (JetPack 7.1)", "Jetson Orin (JetPack 7.2 / R39.2)"]}>
<div class="nv-tab-panel active">
