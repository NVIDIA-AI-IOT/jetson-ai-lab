...
![Qwen3.5 9B NVFP4 generating the same prompt with DFlash speculative decoding enabled on the left and disabled on the right](/images/tutorials/speculative-decoding/qwen3-5-9b-speculative-decoding-comparison.gif)
